...
export const easings = {
  ...
  out: "easeOut",
  inOut: "easeInOut",
  springSoft: { type: "spring", damping: 25, stiffness: 300 },
};
...
export const titleVariants = {
  ...
  visible: {
    opacity: 1,
    y: 0,
    transition: { duration: durations.slow, delay: entranceStagger.header, ease: easings.standard },
  },
};
...
export const uploadVariants = {
  ...
  visible: {
    opacity: 1,
    y: 0,
    transition: { duration: durations.slow, delay: entranceStagger.upload, ease: easings.standard },
  },
};
